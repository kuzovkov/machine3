...
sudo docker-compose exec db sh -c "drop_db -U $DB_USER -h localhost -p 5432 $DB_NAME";
sudo docker-compose exec db sh -c "create_db -U $DB_USER -h localhost -p 5432 -O $DB_USER -T template0 $DB_NAME";
